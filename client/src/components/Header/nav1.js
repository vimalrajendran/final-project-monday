            ...
            <Navbar bg="dark" expand="lg" variant='dark'>
                <Container fluid>
                    ...
                    <Navbar.Collapse id="navbarScroll">
                        ...
                        {
                            !user ? <div><Button className='ms-2' variant='secondary' onClick={() => navigate('/bmi')}>Check Your BMI</Button>
                                ...
                                <NavDropdown className="mx-5"
                                    ...
                                    title={
                                        <span className="text-secondary my-auto">{name}</span>
                                    }
                                    menuVariant="dark"
                                > 
                                    <NavDropdown.Item href="#action/3.1" onClick={ ()=>navigate('/profile')}>Profile</NavDropdown.Item>
                                    <NavDropdown.Item href="#action/3.1" onClick={ ()=>navigate('/bmi')}>BMI</NavDropdown.Item>
                                    <NavDropdown.Item href="#action/3.2" onClick={ ()=>navigate('/fav')}>
                                        Favourites 
                                    </NavDropdown.Item>
